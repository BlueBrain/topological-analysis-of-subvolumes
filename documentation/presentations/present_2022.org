#+PROPERTY: header-args:jupyter-python :session ~/jupyter-run/active-topo-ssh.json
#+PROPERTY: header-args:jupyter :session ~/jupyter-run/active-topo-ssh.json
...
#+begin_src jupyter-python
size = subtarget_sizes.values
subtargets_to_extract = (subtargets_sizes.index[2000 <= size, size < 5000]
