#+PROPERTY: header-args:jupyter :session  ~/Library/Jupyter/runtime/active-ssh-2.json :pandoc t
#+PROPERTY: header-args:jupyter-python :session ~/Library/Jupyter/runtime/active-ssh-2.json :pandoc t
#+STARTUP: overview
