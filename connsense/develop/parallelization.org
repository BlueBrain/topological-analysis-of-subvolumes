#+PROPERTY: header-args:jupyter :session  ~/Library/Jupyter/runtime/active-py38-ssh.json :pandoc t
#+PROPERTY: header-args:jupyter-python :session ~/Library/Jupyter/runtime/active-py38-ssh.json :pandoc t
#+STARTUP: overview
...
We will plot golden aspect ratios:  1.618033988749895
 2022-10-24 08:21:35,404: Configure slurm for create-index
 2022-10-24 08:21:35,404: No runtime configured for computation type create-index
 2022-10-24 08:21:35,405: Configure slurm for define-subtargets
 2022-10-24 08:21:35,406: Configure slurm for extract-node-populations
 2022-10-24 08:21:35,406: Configure slurm for extract-edge-populations
 2022-10-24 08:21:35,407: Configure slurm for analyze-connectivity
Available analyses:
Available analyses:
{'connectivity': {'model-params-dd2': <connsense.develop.topotap.TapDataset object at 0x7fff044fe760>,
                  'simplex-counts': <connsense.develop.topotap.TapDataset object at 0x7fff044fe430>}}
#+end_example
...
Controling an analysis' input will proceed by transforming each input according to the configured ~transformations~. There may be more than ~dataset~ inputs to an analysis method, which will have a common index. Each of the transformation method should also respond to the full input of the analysis method.
...
The second example is that of analyzing subsets of an input --- for example the /intra-layer-subgraphs/. We will be guided by how we have implemented controls.
...
<<develop-parallelization-single-node-multiprocess-batched-edge-populations>>
