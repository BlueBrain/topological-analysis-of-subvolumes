#+PROPERTY: header-args:jupyter :session  ~/Library/Jupyter/runtime/active-1-ssh.json :pandoc t
#+PROPERTY: header-args:jupyter-python :session ~/Library/Jupyter/runtime/active-1-ssh.json :pandoc t
#+STARTUP: overview
