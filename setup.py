...
setup(name="Topological Characterization",
      ...
      entry_points = {"console_scripts": ["tap-environemnt=connsense.apps.tap_environment:main",
                                          ...
                                          "tap-subtargets=connsense.apps.run_define_subtargets:main",
                                          "tap-atlas=connsense.apps.run_extract_voxels:main",
                                          "tap-composition=connsense.apps.run_extract_node_populations:main",
                                          "tap-connectivity=connsense.apps.run_extract_connectivity:main",
